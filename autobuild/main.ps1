...
./auto_build/Helianthus/svn-update.ps1
./auto_build/Helianthus/build.ps1

# 1. 从 version.h 提取版本号
$versionHeader = "D:\work\project\helianthus\build\Desktop_Qt_6_9_1_MSVC2022_64bit-Release\version.h"
...
# 路径配置
$exeSource = "D:\work\project\helianthus\build\Desktop_Qt_6_9_1_MSVC2022_64bit-Release\Helianthus.exe"
$latestDir = "D:\work\output\Helianthus\latest"
$outputDir = "D:\work\output\Helianthus"
$updateFile = Join-Path $outputDir "update.txt"
$updateJsonFile = Join-Path $outputDir "update.json"
$zipFileName = "Helianthus_${timestamp}.zip"
$zipFilePath = Join-Path $outputDir $zipFileName
$downloadUrl = "http://192.168.123.233:8020"
...
# 复制 EXE
Write-Host ">> 正在复制 Helianthus.exe 到 latest 文件夹..."
...
$nsisScript = "D:\work\output\auto_build\Helianthus\nsis_Helianthus.nsi"

if (Test-Path $makensis) {
    Write-Host ">> 正在打包安装程序 Helianthus_Setup_${timestamp}.exe"
...
$installerName = "Helianthus_${version}_${timestamp}.exe"
